...
lib/linux/amd64/libm3.a: build/wasm3
	...
	cd build/wasm3 && cmake -B build-linux-amd64
	cd build/wasm3 && make -C build-linux-amd64
...
lib/linux/arm64/libm3.a: build/wasm3
	...
	cd build/wasm3 && cmake -B build-linux-arm64
	cd build/wasm3 && make -C build-linux-arm64
...
lib/android/arm64/libm3.a: build/wasm3
	...
	cd build/wasm3 && cmake -B build-android-arm64 -DANDROID_ABI=arm64-v8a -DANDROID_NATIVE_API_LEVEL=28 -DCMAKE_TOOLCHAIN_FILE=${ANDROID_NDK_HOME}/build/cmake/android.toolchain.cmake
	cd build/wasm3 && make -C build-android-arm64
